...
/**
 * Individual toast notification component with auto-dismiss
 */
export function Toast({ id, message, type, duration = 5000, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-start gap-3 rounded-xl border px-4 py-3 shadow-lg transition-all duration-300 ${toastStyles[type]}`}
      role="alert"
      aria-live="polite"
      aria-atomic="true"
    >
